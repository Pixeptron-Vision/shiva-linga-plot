...
%     app.LordSivaApp
  ...
  methods
    ...
    function startApp(obj)
        ...
        if nargout(@SivalingamApp) == 0  
            eval('SivalingamApp');
        else
			obj.AppHandle = eval('SivalingamApp');   
        end 
        % Increment the reference count by one    
        LordSivaApp.refcount(obj.Increment);
